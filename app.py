...
# SAFE PAGE ROUTER v30.12 (Fixed Version)
# ==============================================================================
...
# ==============================================================================
# PAGE CONFIG (Streamlit Rule: Must be the very first st command)
# ==============================================================================
st.set_page_config(
...
# သင့် Project ထဲက Supabase client ကို import လုပ်ခြင်း (NameError မတက်စေရန်)
from database import supabase  # လိုအပ်ပါက ဖိုင်အမည်ကို မိမိတို့ ပရောဂျက်အတိုင်း ပြင်သုံးပါ
...
def load_page(page_id):
    ...
    try:
        ...
        # Important: Register module before execute to support relative imports
...
def page_router():
    ...
    # အကယ်၍ 1_POS ဖြစ်နေလျှင် သို့မဟုတ် သက်ဆိုင်ရာ Page ကို တိုက်ရိုက် load လုပ်မည်
    if page_id == "1_POS":
