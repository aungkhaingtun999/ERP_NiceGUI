...
def main():
    ...
    <div class="report-header">
        ...
        <p class="report-subtitle">ERP Enterprise Refund Reporting System v5.2</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    # Display KPI metrics
    kpi_data = display_kpi_metrics(filtered)
    
    # Display full report table
    display_full_report_table(filtered, filters, kpi_data)
    
    # Display refund details
    display_refund_details(filtered)
    
    # Display analytics
    display_analytics(filtered)
